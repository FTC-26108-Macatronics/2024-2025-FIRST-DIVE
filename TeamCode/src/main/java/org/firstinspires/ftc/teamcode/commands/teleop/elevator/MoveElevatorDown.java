...
public class MoveElevatorDown extends CommandBase {
    ...
    public MoveElevatorDown(ElevatorSubsystem m_elevatorSubsystem, GamepadEx m_driverController) {
...
//        m_elevatorSubsystem.stopLift();
    ...
    @Override
    public void execute() {
//        m_elevatorSubsystem.moveLift(-1, m_driverController.getButton(GamepadKeys.Button.START));
