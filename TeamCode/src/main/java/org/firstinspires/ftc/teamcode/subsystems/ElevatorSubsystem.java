...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    public ElevatorPosition getElevatorEnumPosition() {
        ...
        if (Math.abs(currentPosition
                - Constants.ElevatorConstants.ELEVATOR_L1_HEIGHT) < Constants.ElevatorConstants.ELEVATOR_ERROR_TOLERANCE
                * 2) {
            return ElevatorPosition.L1;
        } else if (Math.abs(currentPosition
                - Constants.ElevatorConstants.ELEVATOR_L2_HEIGHT) < Constants.ElevatorConstants.ELEVATOR_ERROR_TOLERANCE
                * 2) {
            return ElevatorPosition.L2;
        } else if (Math.abs(currentPosition
                - Constants.ElevatorConstants.ELEVATOR_L3_HEIGHT) < Constants.ElevatorConstants.ELEVATOR_ERROR_TOLERANCE
                * 2) {
